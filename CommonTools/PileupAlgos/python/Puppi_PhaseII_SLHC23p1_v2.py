...
puppi = cms.EDProducer("PuppiProducer",#cms.PSet(#"PuppiProducer",
                       ...
                       algos          = cms.VPSet( 
                        cms.PSet( 
                         ...
                         ptMin  = cms.vdouble(0.1),
                         MinNeutralPt   = cms.vdouble(0.1),
                         MinNeutralPtSlope   = cms.vdouble(0.005),
                         RMSEtaSF = cms.vdouble(1.0),
                         MedEtaSF = cms.vdouble(1.0),
                         EtaMaxExtrap = cms.double(1.5),
                        ...
                        cms.PSet( 
                         ...
                         ptMin  = cms.vdouble(0.1),
                         MinNeutralPt   = cms.vdouble(1.0),
                         MinNeutralPtSlope   = cms.vdouble(0.025),
                         RMSEtaSF = cms.vdouble(1.0),
                         MedEtaSF = cms.vdouble(1.0),
                         EtaMaxExtrap = cms.double(-3.0),
                         puppiAlgos = puppiCentral
                        ),
                       cms.PSet( 
                         etaMin = cms.vdouble(3.0),
                         etaMax = cms.vdouble(5.0),
                         ptMin  = cms.vdouble(0.1),
                         MinNeutralPt   = cms.vdouble(1.0),
                         MinNeutralPtSlope   = cms.vdouble(0.05),
                         RMSEtaSF = cms.vdouble(1.0),
                         MedEtaSF = cms.vdouble(1.0),
                         EtaMaxExtrap = cms.double(-5.0),
