...
private:
  ...
  //void process_SW(l1t::PFCandidateCollection *il1PFCandidates, l1t::PFTauCollection &iTaus) const;
  void process_SW(std::vector<edm::Ptr<l1t::PFCandidate>> parts, l1t::PFTauCollection &iTaus);
  void process_HW(std::vector<edm::Ptr<l1t::PFCandidate>> parts, l1t::PFTauCollection &iTaus) const; 

  void addTau(const l1t::PFCandidate& iCand,
              std::vector<edm::Ptr<l1t::PFCandidate>> parts,
              l1t::PFTauCollection &outputTaus);
  float deltaR(const l1t::PFCandidate &iPart1, const l1t::PFCandidate &iPart2);
  void produce(edm::Event &iEvent, const edm::EventSetup &iSetup) override;
  void makeTau_HW(edm::Ptr<l1t::PFCandidate> seed,std::vector<edm::Ptr<l1t::PFCandidate>>& parts,l1t::PFTauCollection &iTaus) const;
